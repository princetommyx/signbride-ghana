...
const LOCAL_GSL_DICT: Record<string, string> = {
  ...
  name: 'Point to your chin and then move your hand outward to indicate a name or identity.',
  is: 'Use a gentle nod combined with a small hand motion to affirm meaning.',
  prince: 'Sign royalty by touching the forehead with a flat hand, then move outward slightly for a title.',
  of: 'Use one hand to indicate possession or relation while the other stays neutral.',
  ...
  he: 'Point slightly to one side while nodding to indicate a male person.',
  she: 'Point slightly to one side while nodding to indicate a female person.',
  her: 'Point to the person with a gentle motion while referring to a female subject.',
  school: 'Hold both hands flat and move them outward from the shoulders to show a learning place.',
  church: 'Form a cross shape with one hand and move it downward to indicate a religious place.',
